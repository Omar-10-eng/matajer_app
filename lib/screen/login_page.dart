...
//   Widget build(BuildContext context) {
//     double screenWidth = MediaQuery.of(context).size.width;
//     double containerWidth = (screenWidth - 16 - 16);
//     return Scaffold(
//       backgroundColor: Colors.white,
//       appBar: AppBar(),
//       body: Center(
...
//                     child: Center(
//                       child: Image.asset(
//                         'assets/soicalmedia/facebook.png',
//                         width: 40,
//                         height: 40,
//                         fit: BoxFit.contain,
//                       ),
...
//                     child: Center(
//                       child: Image.asset(
//                         'assets/soicalmedia/Symbol.svg.png',
//                         width: 40,
//                         height: 40,
//                         fit: BoxFit.contain,
//                       ),
